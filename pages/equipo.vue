...
const integrativeSupport = computed(() =>
  locale.value === 'es'
    ? [
        ...
        { role: 'Psicología oncológica (Asociación CMM)', description: 'Psicóloga especializada en acompañamiento emocional a personas con cáncer. Colabora desde la Asociación CMM.', icon: 'ph:heart-fill', color: 'gold' as const },
        { role: 'Psicología y altas capacidades (AACC)', description: 'Psicóloga con especialización en altas capacidades (AACC). Acompaña a Míriam integrando la dimensión cognitiva con el proceso oncológico.', icon: 'ph:brain-fill', color: 'ocean' as const },
    ...
    : [
        ...
        { role: 'Oncology Psychology (CMM Association)', description: 'Psychologist specialised in emotional support for people with cancer. Collaborates through the CMM Association.', icon: 'ph:heart-fill', color: 'gold' as const },
        { role: 'Psychology & High Abilities (AACC)', description: 'Psychologist specialising in high abilities (AACC). Supports Míriam by integrating the cognitive and emotional dimensions of her process.', icon: 'ph:brain-fill', color: 'ocean' as const },
